        ...
        <div class="main-wrapper">
            <div class="app" id="app">
                ...
                <li>
                                    ...
                                    <ul>
                                        <li> <a id="chk_status" href="check-stream">
    								Check Status
    							</a> </li>
                                        <li> <a id="set_status" href="channel-streaming-status">
    								Set Status
    							</a> </li>
                                    </ul>
                                </li>
				...
				<li>
                                    <a href="extra-params.php"> <i class="fa fa-th-large"></i> Extra Parameter Settings <i class="fa arrow"></i> </a>
				...
				<li>
                                    ...
                                    <ul>
                                        <li> <a href="admin-channel-info-management.php.php">
    								Channel Info Management
    							</a> </li>
                                        <li> <a href="admin-bouquet-management.php">
    								BOUQUET Management
    							</a> </li>
					 <li> <a href="admin-channel-management.php">
    								CHANNEL Management
    							</a> </li>
                                    </ul>
                                </li>
				...
				<li>
                                    <a href="admin-user-control.php"> <i class="fa fa-th-large"></i>Admin Users' Control <i class="fa arrow"></i> </a>
                                    
                                </li>
                                <li>
                                    <a href="admin-siteaccess-user-control.php"> <i class="fa fa-th-large"></i>QezyPlay Specail Users' Control <i class="fa arrow"></i> </a>
