...
echo "<setion class='section' style='text-align:center'>
<div class='row sameheight-container'>

<h4 style='float:'>ACTIVE USERS: $active_users";
...
echo "
	...
	<div class='col-xs-18 col-sm-12' id='active_users' style='display:none'>
	<div class='card'>
...
<tr><td style='float:'><?php echo $dp_name ?></td><td>   from  </td><td><?php echo $city ?></td><td> <?php echo $state ?> , <?php echo $country ?> </td></tr> 
...
echo "<div class='col-xs-18 col-sm-12' id='live_chan' align='center' style='display:none;'>";
echo "
<div class='card' style='max-width:600px'>
                                    <div class='card-block'>
                                        <div class='card-title-block'>
                                            <h3 class='title'>
							LIVE CHANNELS: ".count($res1)."
						</h3> </div>
                                        <section class='example'>	
";
foreach($res1 as $r1)
