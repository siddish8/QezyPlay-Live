...
.mx{max-width:100%;margin:0 auto !important;}
 /* Style the list */
ul.tab {
...
?></h4></div>     
    <br />    <div style="float:right;">
        <a style="color:#2a85e8;border: 2px solid black;padding: 0px 6px;display:inline-block;" href="#" onclick="return other_user_btn()" >Validate Another User</a>
<span style="display:inline-block;">&nbsp; &nbsp;</span>
        <a style="color:#2a85e8;border: 2px solid black;padding: 0px 6px;display:inline-block;" href="<?php
    echo SITE_URL;
?>/register" target="_blank">Create New Registration</a></div>
<br>
<br>
<section class="section">
        <div id="emailchkdiv">
