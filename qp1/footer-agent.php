<?php
?>
 <footer class="footer" style="background-color:#d7dde4">
                    ...
                    <div class="footer-block author pull-left">
                        <ul>
...
<a href="mailto:contact@qezymedia.com">Email us</a></li><li><span><i class="fa fa-phone"></i></span>
+91-910 002 9200</li>
