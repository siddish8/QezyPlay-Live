...
<ul class="nav nav-tabs nav-tabs-bordered">
                                            <li class="nav-item"> <a id="CR" href="#home" class="nav-link active" data-target="#CreditRequest" data-toggle="tab" aria-controls="home" role="tab">Request for Subscribe</a> </li>
                                            <li class="nav-item"> <a id="PR" href="#profile" class="nav-link" data-target="#PendingRemittance" aria-controls="profile" data-toggle="tab" role="tab">Remittance Pending</a> </li>
                                            <li class="nav-item"> <a id="SL" href="" class="nav-link" data-target="#SubscriberList" aria-controls="messages" data-toggle="tab" role="tab">Subscribers List</a> </li>
                                                                                 </ul>
<!-- 
<div align="center" style="margin:0 auto">  <ul class="tab mx">
...
<input type="hidden" id="AID" value="<?php echo $agent_id?>" />
		...
		<div class="tab-content tabs-bordered">
                                            <div class="tab-pane fade in" id="PendingRemittance">
...
?>
	...
	<!-- <div id="SubscriberList" class="tabcontent mx"> -->
		<div class="tab-content tabs-bordered">
                                            <div class="tab-pane fade in" id="SubscriberList">
 ...
 <div class="tab-content tabs-bordered">
                                            <div class="tab-pane fade in active" id="CreditRequest">
