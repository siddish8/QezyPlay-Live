  ...
  if (user != "") {
	...
	jQuery("#reg_user_login_err").css("background-color","transparent");
		...
		SweetAlertMultiInputReset();
            ...
            function(isConfirm) {window.location.href="../register"});
                    return true;
                  }
                });
                return false;
    ...
    jQuery.ajax({
      ...
      success: function(response) {
        ...
        if (response == 2) {
          ...
          val1.style.outline = "medium none";
          document.getElementById("reg_user_email_err_div").style.display = "block";
	jQuery("#reg_user_email_err").css("background-color","transparent");
