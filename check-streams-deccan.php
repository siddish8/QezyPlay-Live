...
//bouquet_id 6 for Deccan
			...
			$sql4="SELECT a.id,a.name,a.url FROM channels a inner join bouquet_vs_channels b on a.id=b.channel_id where a.status=1 and b.bouquet_id=6";
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <div class="card-title-block">
                                            <h3 class="title">
							Channels and Streaming Status - Deccan Plateau Channels
						</h3> </div>
...
function funcOnError(msg, code) {
	...
	//alert(window.err);
        ...
        window.location.href="../check-streams-deccan.php";
