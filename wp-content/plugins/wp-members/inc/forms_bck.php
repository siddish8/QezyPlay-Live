...
if(!check && (val1!="")){document.getElementById("user").setCustomValidity("UserName should not contain spaces, special char or shouldn\'t start with underscore"); return false;}
...
if(!check && (val1!="")){document.getElementById("log").setCustomValidity("UserName should not contain spaces, special char or shouldn\'t start with underscore"); return false;}
...
if(!check && (val!="")){document.getElementById("log").setCustomValidity("UserName should not contain spaces, special char or shouldn\'t start with underscore"); return false;}
...
document.getElementById("Update Password").addEventListener("click", function(event) {
	...
	document.getElementById("err_log").style.display="none";
		...
		'row_before'      => '',
		'row_after'       => '',
		'buttons_before'  => '</h3><div class="button_div">',
		'buttons_after'   => '</div>',
...
if(!check && (val4!="")){document.getElementById("log").setCustomValidity("UserName should not contain spaces, special char or shouldn\'t start with underscore"); return false;}
else {document.getElementById("log").setCustomValidity(""); }
