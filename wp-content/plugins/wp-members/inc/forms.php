...
var check=validateUsername(val1);
if(val1==""){document.getElementById("user").setCustomValidity("Please enter username"); return false;}
if(!check && (val1!="")){document.getElementById("user").setCustomValidity("UserName should not contain special char and shouldn\'t start with underscore"); return false;}
else {document.getElementById("user").setCustomValidity("");}

 var val2=document.getElementById("email").value;
var check=validateEmail(val2);
if(val2==""){document.getElementById("email").setCustomValidity("Please enter email"); return false;}
if(!check && (val2!="")){/*document.getElementById("emailErr").innerHTML="Enter a valid email"; */ document.getElementById("email").setCustomValidity("Enter a valid email"); return false;}
else {document.getElementById("email").setCustomValidity(""); return true;}

}
if(id=="user")
{
 var val=document.getElementById("user").value;
var check=validateUsername(val);
if(val==""){document.getElementById("user").setCustomValidity("Please enter username"); return false;}
if(!check && (val1!="")){document.getElementById("user").setCustomValidity("UserName should not contain special char and shouldn\'t start with underscore"); return false;}
else {document.getElementById("user").setCustomValidity(""); return true;}
}
...
if(val==""){document.getElementById("email").setCustomValidity("Please enter email"); return false;}
if(!check && (val!="")){/*document.getElementById("emailErr").innerHTML="Enter a valid email"; */ document.getElementById("email").setCustomValidity("Enter a valid email"); return false;}
else {document.getElementById("email").setCustomValidity(""); return true;}
}
if(id=="Log In")
{
 var val1=document.getElementById("log").value;
var check=validateUsername(val1);
if(val1==""){document.getElementById("log").setCustomValidity("Please enter username"); return false;}
if(!check && (val1!="")){document.getElementById("log").setCustomValidity("UserName should not contain special char and shouldn\'t start with underscore"); return false;}
else {document.getElementById("log").setCustomValidity("");}

var val2=document.getElementById("pwd").value;
if(val2==""){document.getElementById("pwd").setCustomValidity("Please enter password"); return false;}
else {document.getElementById("pwd").setCustomValidity(""); return true;}
...
var check=validateUsername(val);
if(val==""){document.getElementById("log").setCustomValidity("Please enter username"); return false;}
if(!check && (val!="")){document.getElementById("log").setCustomValidity("UserName should not contain special char and shouldn\'t start with underscore"); return false;}
else {document.getElementById("log").setCustomValidity(""); return true;}
}
if(id=="pwd")
{
var val=document.getElementById("pwd").value;
if(val==""){document.getElementById("pwd").setCustomValidity("Please enter password"); return false;}
else {document.getElementById("pwd").setCustomValidity(""); return true;}
}
if(id=="Update Password")
{
var val1=document.getElementById("pass1").value;
var check=validatePass(val1);
if(val1==""){document.getElementById("pass1").setCustomValidity("Please enter password"); return false;}
if(!check && (val1!="")){document.getElementById("pass1").setCustomValidity("Must contain min of 8 characters with 1 uppercaseLetter,1 number,1 special char"); return false;}
else {document.getElementById("pass1").setCustomValidity("");}

var val2=document.getElementById("pass2").value;
var check=(val1==val2);
if(val2==""){document.getElementById("pass2").setCustomValidity("Please enter password again"); return false;}
if(!check && (val2!="")){document.getElementById("pass2").setCustomValidity("Passwords did not match"); return false;}
else {document.getElementById("pass2").setCustomValidity(""); return true;}
...
if(val1==""){document.getElementById("pass1").setCustomValidity("Please enter password"); return false;}
if(!check && (val1!="")){document.getElementById("pass1").setCustomValidity("Must contain min of 8 characters with 1 uppercaseLetter,1 number,1 special char"); return false;}
else {document.getElementById("pass1").setCustomValidity(""); return true;}
}
if(id=="pass2")
{
var val1=document.getElementById("pass1").value;
...
var elementExists = document.getElementById("log");
if(elementExists){
...
document.getElementById("pwd").addEventListener("click", function(event) {
    	document.getElementById("err_log").style.display="none";
    });
...
var elementExists2= document.getElementById("user");
if(elementExists2){
...
document.getElementById("Update Password").addEventListener("click", function(event) {
	...
	foreach ( $arr['inputs'] as $input ) {
		...
		$field = wpmem_create_formfield( $input['tag'], $input['type'], '', '', $input['class'], $input['required']);
	...
	if ( $arr['action'] == 'login' ) {
		...
		$args['remember_check'] = ( $args['remember_check'] ) ? $args['t'] . wpmem_create_formfield( 'rememberme', 'checkbox', 'forever' ) . '&nbsp;' . __( '<p id="ReMe">Remember Me</p>' ) . '&nbsp;' . $args['n'] : '';

		$buttons =  $args['remember_check'] . $args['t'] . '<p style="margin:0;font-size:9px;" id="t&c">*By clicking on Log In, you agree to our <a href="../terms-of-service">Terms of Service</a> and that you have read our <a href="../privacy-policy">Privacy Policy</a></p><input id="' . $arr['button_text'] . '" type="submit" onclick="validate(this.id)" name="Submit" value="' . $arr['button_text'] . '" class="' . $args['button_class'] . '" />' . $args['n'];
		
	} else {
		$buttons = '<input id="' . $arr['button_text'] . '" type="submit" onclick="validate(this.id)" name="Submit" value="' . $arr['button_text'] . '" class="' . $args['button_class'] . '" />' . $args['n'];
	}
	...
	if ( ( $wpmem->user_pages['register'] != null ) && $arr['action'] == 'login' ) { 
		...
		$str  = __( '<br /> <br /> New User?', 'wp-members' ) . '&nbsp;<a href="' . $link . '">' . __( 'Sign-up Now', 'wp-members' ) . '</a>';
$str  .= "<br /><a href='../forgot-password/'>Forgot Password?</a>";
...
if(id=="Register")
{
var val4=document.getElementById("log").value;
var check=validateUsername(val4);
if(val4==""){document.getElementById("log").setCustomValidity("Please enter username"); return false;}
if(!check && (val4!="")){document.getElementById("log").setCustomValidity("UserName should not contain special char and shouldn\'t start with underscore"); return false;}
else {document.getElementById("log").setCustomValidity(""); }


var val3=document.getElementById("user_email").value;
var check=validateEmail(val3);
if(val3==""){document.getElementById("user_email").setCustomValidity("Please enter email"); return false;}
if(!check && (val3!="")){document.getElementById("user_email").setCustomValidity("Enter a valid email"); return false;}
else {document.getElementById("user_email").setCustomValidity(""); }


/* var val1=document.getElementById("password").value;
var check=validatePass(val1);
if(val1==""){document.getElementById("password").setCustomValidity("Please enter password"); return false;}
if(!check && (val1!="")){document.getElementById("password").setCustomValidity("Must contain min of 8 characters with 1 uppercaseLetter,1 number,1 special char"); return false;}
else {document.getElementById("password").setCustomValidity(""); }

var val2=document.getElementById("confirm_password").value;
var check=(val1==val2);
if(val2==""){document.getElementById("confirm_password").setCustomValidity("Please enter password again"); return false;}
if(!check && (val2!="")){document.getElementById("confirm_password").setCustomValidity("Passwords did not match"); return false;}
else {document.getElementById("confirm_password").setCustomValidity(""); return true;} */
...
var check=validateEmail(val);
if(val==""){document.getElementById("user_email").setCustomValidity("Please enter email"); return false;}
if(!check && (val!="")){document.getElementById("user_email").setCustomValidity("Enter a valid email"); return false;}
else {document.getElementById("user_email").setCustomValidity(""); return true;}
}
...
if(val1==""){document.getElementById("password").setCustomValidity("Please enter password"); return false;}
if(!check && (val1!="")){document.getElementById("password").setCustomValidity("Must contain min of 8 characters with 1 uppercaseLetter,1 number,1 special char"); return false;}
else {document.getElementById("password").setCustomValidity(""); return true;}
}
...
return re.test(pass);
 ...
 document.getElementById("t&c").innerHTML="*By clicking on Register, you agree to our <a href=\"../terms-of-service\">Terms of Service</a> and that you have read our <a href=\"../privacy-policy\">Privacy Policy</a>";

/* document.getElementById("p-log").innerHTML="* UserName should not contain special char and shouldn\'t start with underscore";
...
document.getElementById("user_email").addEventListener("click", function(event) {
...
document.getElementById("p-password").innerHTML="* Must contain min of 8 characters with 1 uppercaseLetter,1 number,1 special char"; */
		...
		'row_before'       => '',
		'row_after'        => '',
		'buttons_before'   => '<p style="margin:0 ;font-size:9px;" id="t&c"></p><div class="button_div">',
		'buttons_after'    => '</div>',
	...
	$buttons.= '<input id="' . $button_text . '" onclick="validate(this.id)" name="submit" type="submit" value="' . $button_text . '" class="' . $args['button_class'] . '" />' . $args['n'];
	 ...
	 * @param string $toggle Toggle new registration or profile update. new|edit.
 	 */
	$heading = ( !$heading ) ? apply_filters( 'wpmem_register_heading', __( 'Register for Free', 'wp-members' ), $toggle ) : $heading;
