...
function wpmem_create_formfield( $name, $type, $value, $valtochk=null, $class='textbox' ) {
	...
	case "text":
		...
		$str = "<input onkeypress='return event.charCode !=32' onblur='validate(this.id)' required=\"required\" name=\"$name\" type=\"$type\" id=\"$name\" value=\"$value\" class=\"$class\" /><p style='font-size: 12px;text-align: center;margin: unset !important;' id=\"p-$name\"></p>";
	...
	case "password":
		...
		$str = "<input onkeypress='return event.charCode !=32' onblur='validate(this.id);' required=\"required\" name=\"$name\" type=\"$type\" id=\"$name\" class=\"$class\" /><p style='font-size: 12px;text-align: center;margin: unset !important;' id=\"p-$name\"></p>";
