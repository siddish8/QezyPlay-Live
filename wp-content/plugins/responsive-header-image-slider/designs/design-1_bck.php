...
/*div[slidesjs-index="0"] > div#slider_content > a > button {
    background-color: #f9c73d;
	color:black !important;
	border: #f9c73d;
}
div[slidesjs-index="0"] > div#slider_content > a > button:hover {
    background-color: black ;
	color:#f9c73d !important;
	border: black;
}*/
...
<div id="slider_content" align="center" style="margin:0 auto;left: 30px;
    ...
    text-align: center;
    /*padding: 10% 30px;*/"><a href="<?php echo $sliderurl; ?>" class="image-link" ><button style="color:white"><?php echo $btn ?></button></a></div> <?php } ?>
<?php
}
