...
$sql="SELECT count(user_id) as count FROM wp_pmpro_memberships_users where user_id = ".$this_user." and user_id<>0" ;
...
<div class="clear"></div>
		<p>
		<form class="frnd" id="frnd<?php echo $level->id ?>" action="../gift-a-friend" method="post">
