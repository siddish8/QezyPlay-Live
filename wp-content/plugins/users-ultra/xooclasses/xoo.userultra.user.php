	...
	public function confirm_reset_password_user()
	{
		...
		if($validation=="" )
		{
			...
			if($user_id >0 )
			{
					...
					$html = "<div class='uupublic-ultra-success'>".__(" Password has reset and sent to ".$user_email."  ", 'xoousers')."</div>";
	...
	public function confirm_reset_password()
	{
		...
		if($validation=="" )
		{
			...
			if($user->ID >0 )
			{
				...
				$html = "<div id='reset-pwd-success' class='uupublic-ultra-success'>".__(" Password has reset and sent to ".$user_email."  ", 'xoousers')."</div>";
