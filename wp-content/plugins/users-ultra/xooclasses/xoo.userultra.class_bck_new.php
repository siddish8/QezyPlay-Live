...
$display .= '<i class="fa fa-'.$icon.'"></i>';
 $display .= ''.$name. ' '.$required_text.'</label>';
    ...
    <label id="'.$meta.'_label" class="xoouserultra-field-type"></label><div id="'.$meta.'_err" class="alert alert-danger xoouserultra-field-value"></div>
		...
		<div><p style="color:black;margin:0;font-size:10px;float:right" id="tos_pp">*By clicking on Login, you agree to our <a href="../terms-of-service">Terms of Service</a> and that you have read our <a href="../privacy-policy">Privacy Policy</a></p> </div>
