...
class XooUserAdmin extends XooUserUltraCommon 
{
	...
	public function set_default_email_messages()
	{
		...
		$email_body .= __('Your account username: {{userultra_user_name}}','xoousers') . $line_break;
		$email_body .= __('Your account password: {{userultra_pass}}','xoousers') . $line_break.$line_break;
		$email_body .= __('Note: You can change your password at {{userultra_change_password}}','xoousers') . $line_break.$line_break;
		$email_body .= __('If you have any problems, please contact us at {{userultra_admin_email}}.','xoousers') . $line_break.$line_break;
		$email_body .= __('Best Regards!','xoousers');
		...
		$email_body .= __('Account e-mail: {{userultra_user_email}}','xoousers') . $line_break;
		$email_body .= __('Account username: {{userultra_user_name}}','xoousers') . $line_break;
		$email_body .= __('Account Phone no: {{userultra_user_phone}}','xoousers') . $line_break;
		...
		$email_body = __('<p>Hi</p>,' ,"xoousers") . $line_break.$line_break;
		$email_body .= __("<p>Please use the following link to reset your password.</p>","xoousers") . $line_break.$line_break;			
		$email_body .= "<p> {{userultra_reset_link}} </p>".$line_break.$line_break;
		$email_body .= __('<br /><br /><p> If you did not request a new password delete this email. </p>','xoousers'). $line_break.$line_break;		$email_body .= __('<br /><br /><p>Best Regards!</p>','xoousers') . $line_break.$line_break;		
