...
';
				...
				echo '<script> 
					...
					swal(\'Sorry for Inconvenience\',\'  Currently we are not having the supporting player for IOS , Will be publised very soon.\');
